...
<form method="post" name="form">
 <fieldset>
  ...
  <input type="password" id="new_password" name="new_password" onkeyup="showUser_current_and_retype_password(this.value,current_password.value)" onblur="checkNewPassword()">
  <span class="error" id="new_passwordErr"> <?php echo $new_passwordErr;?></span>

  <div id="txtHint_5"><b>new password's status will be shown here...</b></div>
  <br><br>
