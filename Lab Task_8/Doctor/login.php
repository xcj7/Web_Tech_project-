...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" name="form">
 <fieldset>
  ...
  <input type="text" id="username" name="username" onkeyup="checkusername()" onblur="checkusername()" value="<?php if(isset($_COOKIE['username'])) {echo $_COOKIE['username'];} ?>">
  <span class="error"> <?php echo $usernameErr;?></span>
  <br><br>

  <label for="password">Password :</label>
  <input type="password" id="password" name="password" onkeyup="checkPassword()" onblur="checkPassword()" value = "<?php if(isset($_COOKIE['password'])) {echo $_COOKIE['password'];} ?>">
